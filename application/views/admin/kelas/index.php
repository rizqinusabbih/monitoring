                                    ...
                                    <?php foreach ($kelas as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url('admin/kelas/delete/' . $row['id_kelas']); ?>" class="btn btn-sm btn-danger" data-placement="top" title="Hapus" onclick="return confirm('Apakah Anda benar-benar ingin menghapus kelas ini?');"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
