                                ...
                                <?php if ($pelanggaran_siswa) : ?>
                                    <?php foreach ($pelanggaran_siswa as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('admin/lappelanggaran/detail/' . $row['id_siswa']); ?>" class="btn btn-sm btn-warning" data-placement="top" title="Detail"><i class="fa fa-search"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
