        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="<?php echo base_url('admin/kategoriprestasi/do_edit/' . $katpres['id_kat_prestasi']); ?>" method="post">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="nama_kategori">Nama Ketegori * :</label>
                                    <input type="text" name="nama_kategori" id="nama_kategori" class="form-control" value="<?php echo $katpres['nama_kategori']; ?>" required />
