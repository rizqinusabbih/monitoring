        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="<?php echo base_url('admin/kategoriprestasi/do_add_subkat'); ?>" method="post">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="id_kat_prestasi" id="id_kat_prestasi" class="form-control">
                                        ...
                                        <?php foreach ($katpres as $one) : ?>
                                            <option value="<?php echo $one['id_kat_prestasi']; ?>"><?php echo $one['nama_kategori']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="nama_subkategori" id="nama_subkategori" class="form-control" value="<?php echo set_value('nama_subkategori'); ?>" required />
                                    <small class="form-text text-danger"><?php echo form_error('nama_subkategori'); ?></small>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="poin_prestasi">Point * :</label>
                                    <input type="number" name="poin_prestasi" id="poin_prestasi" class="form-control" value="<?php echo set_value('poin_prestasi'); ?>" required />
