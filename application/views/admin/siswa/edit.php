        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="<?php echo base_url('admin/siswa/do_edit/' . $siswa['id_siswa']); ?>" method="post">
                            <div class="form-row">
                                <input type="hidden" name="id_tahun_akademik" id="id_tahun_akademik" class="form-control" value="<?php echo $siswa['id_tahun_akademik']; ?>" readonly />
                                <div class="form-group col-md-12">
                                    <label for="nis">NIS * :</label>
                                    <input type="text" name="nis" id="nis" class="form-control" value="<?php echo $siswa['nis']; ?>" required />
                                    <small class="form-text text-danger"><?php echo form_error('nis'); ?></small>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="nama_siswa">Nama Siswa * :</label>
                                    <input type="text" name="nama_siswa" id="nama_siswa" class="form-control" value="<?php echo $siswa['nama_siswa']; ?>" required />
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="nama_ibu" id="nama_ibu" class="form-control" value="<?php echo $siswa['nama_ibu']; ?>" />
