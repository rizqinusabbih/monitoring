<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><img src="<?php echo base_url('assets/images/icon.png'); ?>" alt="logo" width="30px"> <span>SI Monitoring</span></a>
        </div>
        ...
        <div class="profile clearfix">
            <div class="profile_pic">
                <img src="<?php echo base_url('assets/'); ?>images/admin.jpg" alt="..." class="img-circle profile_img">
            </div>
